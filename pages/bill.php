...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   $_SESSION['order']['country'] = ['name' => $_POST['country'], 'price' => $countries[$type][$_POST['country']]];
   if (!empty($_POST['services'])) {
      foreach ($_POST['services'] as $serviceName) {
          // Проверяем, что услуга существует для данного типа путевки
         $price = $services[$_SESSION['order']['type']['name']][$serviceName];
         $selectedServices[] = ['name' => $serviceName, 'price' => $price];
      }
  }
   $_SESSION['order']['services'] = $selectedServices;
   $_SESSION['order']['days'] = (int)$_POST['days'];
                           ...
                           <tr>
                              <td width="492" valign="top" height="106">
                                 ...
                                 <div style="margin-left:1px; margin-top:2px; margin-right:10px "><br>
                                    ...
                                    <div style="margin-left:95px "><font class="title">Вокруг света за 80 дней</font>
                                    ...
                                    <form action="bill.php" method="post">
                                       <h3>Страна</h3>
                                          <?php foreach ($countries[$_SESSION['order']['type']['name']] as $country => $price): ?>
                                             <label>
                                                <input type="radio" name="country" value="<?= $country ?>" required checked>
                                                <?= $country ?>
                                             </label><br>
                                          <?php endforeach; ?>
                                    </div> 
                                    ...
                                    <tr>
                                       <td valign="top" height="232" width="248">
                                          ...
                                          <div style="margin-top:10px; margin-left:6px ">
                                             <h3>Дополнительные услуги</h3>
                                                <?php foreach ($services[$_SESSION['order']['type']['name']] as $service => $price): ?>
                                                   <label>
                                       ...
                                       <td valign="top" height="215" width="243">
                                          ...
                                          <div style="margin-left:22px; margin-top:13px; ">
                                             ...
                                             <input type="number" name="days" min="1" value="1" required><br>
